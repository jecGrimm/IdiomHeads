...
if not os.path.isdir("./scores/literal_components"):
    os.mkdir("./scores/literal_components")

if not os.path.isdir(f"./scores/literal_components/{model_name.split('/')[-1]}"):
    os.mkdir(f"./scores/literal_components/{model_name.split('/')[-1]}")
...
for i in range(len(data_split)):
    ...
    comp_file = f"./scores/literal_components/{model_name.split('/')[-1]}/literal_only_{split}_{start}_{end}_comp.pt"
