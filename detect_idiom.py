...
# formal scores
formal_score_per_head = idiom_scorer.get_avg_idiom_scores(epie.formal_sents, epie.tokenized_formal_sents, epie.tags_formal)

if not os.path.isdir("./scores"):
    os.mkdir("./scores")

idiom_scorer.save_scores(formal_score_per_head, f"./scores/{model_name.split('/')[-1]}_avg.json")
